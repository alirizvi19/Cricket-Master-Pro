      ...
      <section className="relative py-12 md:py-20 px-2 sm:px-6 md:px-8 overflow-hidden">
        <div className="relative z-10 space-y-6 md:space-y-8 flex flex-col items-center md:items-start text-center md:text-left">
          <motion.div
            ...
            className="inline-flex flex-wrap items-center justify-center md:justify-start gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/10 text-[9px] sm:text-[10px] font-mono uppercase tracking-widest text-brand"
          >
            <Star size={12} className="fill-current shrink-0" />
            <span className="truncate">Real-time Cricket Ecosystem</span>
          </motion.div>
          
          <motion.h1
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            className="text-5xl md:text-7xl lg:text-9xl font-black uppercase leading-[1.1] md:leading-none tracking-tighter text-white"
          >
          ...
          <motion.p
            ...
            className="max-w-md text-base md:text-lg text-text-dim font-medium px-4 md:px-0"
          >
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-4 w-full sm:w-auto px-4 sm:px-0">
            <Link to="/tournaments" className="w-full sm:w-auto justify-center bg-brand text-black px-8 py-4 rounded-xl font-bold uppercase tracking-widest text-[10px] sm:text-xs flex items-center gap-2 hover:scale-105 transition-transform shadow-lg shadow-brand/20">
